...
--
-- NOTE: the URL carries the ?v=1 cache-buster that matches the current
...
-- any time after 36_setlist_19jul2026.sql.
-- ============================================================
...
where p.service_date = '2026-07-19' and s.role = 'Sermon';
