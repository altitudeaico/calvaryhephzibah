-- ============================================================
-- 70_sermon_image_13sep2026.sql
-- ============================================================
-- Register the 13 September sermon thumbnail in the Control Room BY
...
-- >> distinct versions at the same filename before ever being
-- >> registered here (initial render -> ChatGPT redraw -> ChatGPT
-- >> redraw + Calvary logo, the final one). v=3 matches the version
-- >> now set in media-briefing-13-sep-2026.html. If it's regenerated
-- >> again, bump BOTH places together or OBS will show cached art.
--
-- Idempotent: re-running replaces the seeded row and re-links it.
-- Run any time after 69_setlist_13sep2026.sql.
-- ============================================================
...
with img as (
  ...
  values (
    'Sermon — 13 Sep 2026 · Resisting and Overcoming Temptation (Pastor Gbenga Adebanjo)',
    'sermon',
    'image',
    'https://calvaryhephzibah.co.uk/sermon-thumbnail-13-sep-2026.jpg?v=3',
    null,
    1280, 720
  )
  returning id
...
where p.service_date = '2026-09-13' and s.role = 'Sermon';
