-- ============================================================
-- 49_sermon_image_02aug2026.sql
-- ============================================================
-- Register the 2 August sermon thumbnail in the Control Room BY URL
...
--
-- >> CACHE-BUSTER: the URL carries ?v=4, matching the current
-- >> thumbnail (rebuilt on the ALTARS series plate, 1 August). If the
-- >> thumbnail is regenerated again, bump the version HERE as well as
-- >> in the run sheet, or OBS will keep showing the cached older art.
--
-- Idempotent: re-running replaces the seeded row and re-links it.
-- Run in the Supabase SQL editor (project: pfycvgbrsbecznkcikwt),
-- any time after 45_setlist_02aug2026.sql.
-- ============================================================
...
with img as (
  ...
  values (
    'Sermon — 2 Aug 2026 · Family Altar (ALTARS)',
    'sermon',
    'image',
    'https://calvaryhfgc.github.io/calvaryhephzibah/sermon-thumbnail-02-aug-2026.jpg?v=4',
    null,
    1280, 720
  )
  returning id
...
where p.service_date = '2026-08-02' and s.role = 'Sermon';
