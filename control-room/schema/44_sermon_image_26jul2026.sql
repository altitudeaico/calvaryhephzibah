...
-- overlay receives the URL and displays it.
--
...
-- any time after 43_orderofservice_26jul2026.sql.
-- ============================================================
...
with img as (
  ...
  values (
    'Sermon — 26 Jul 2026 · ALTARS',
    'sermon',
    'image',
    'https://calvaryhfgc.github.io/calvaryhephzibah/sermon-thumbnail-26-jul-2026.jpg?v=3',
    null,
    1280, 720
  )
  returning id
...
where p.service_date = '2026-07-26' and s.role = 'Sermon';
